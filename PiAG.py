...
power_down =          0 # set = 1 to power down the Pi when you exit the script, clicking Esc twice.
                        # To stop the script without existing when set, click 'Esc' then 'Stop' within 5 secs.
#=============================================================================================================
# CONNECTION SETTINGS
...
minc =                5 # minimum correction in pixels
...
#display graph if enabled
   ...
   if esc1 == 1 and time.time() - esctimer > 5:
      keys(0,"Esc", fs, 5, b3x, bw, 2, b3y, bh, 2, 2, 0)
      esc1 = 0
...
# read mouse or Keyboard
   ...
   for event in pygame.event.get():
       if event.type == QUIT:
          ...
          if esc1 > 0 and z != 141 and z != 143 and z != 154 and kz != K_ESCAPE:
             esc1 = 0
             keys(0,"Esc",fs,5,b3x,bw,2,b3y, bh, 2, 2, 0)
