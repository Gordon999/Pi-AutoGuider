...
# read mouse or Keyboard
   ...
   # change window by holding right hand mouse button
   if buttonx[2] != 0 and Display == 0 and store == 0:
      pos = pygame.mouse.get_pos()
      xouse = pos[0]
      youse = pos[1]
      store = 1
   if buttonx[2] != 0 and Display == 0 and store == 1:
      pos = pygame.mouse.get_pos()
      mousexx = pos[0]
      mouseyy = pos[1]
      if mousexx < Disp_Width and mouseyy < height:
   ...
   if buttonx[0] != 0 or mousepress == 1:
      press = 1
      mousepress = 0
      pos = pygame.mouse.get_pos()
      mousex = pos[0]
