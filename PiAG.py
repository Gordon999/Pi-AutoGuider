...
def keys(bcolor,msg, fsize, fcolor, fx, bw, hp, fy, bh, vp, vo, upd):
   ...
   fx += 2 + hp*bw
   if msg == "Exp Time" or msg == "     eV" or msg == "Cam Angle" or msg == "scale all":
...
#display graph if enabled
   ...
   # calibrate RA
      ...
      if (abs(ccorrect)) > move_limit or (abs(dcorrect)) > move_limit:
         ...
         if abs(Dang) > 95 and abs(Rang) < 85 :
            nsi += 1
            if nsi > 1:
               nsi = 0
            if Dang > 100:
         ...
         if abs(Rang) > 95 and abs(Dang) < 85 :
            ewi +=1
            if ewi > 1:
               ewi = 0
            if Rang > 100:
         ...
         if abs(Rang) > 95 and abs(Dang) > 95 :
            ewi +=1
            if ewi > 1:
               ewi = 0
            nsi +=1
...
# read mouse or Keyboard
   ...
   for event in pygame.event.get():
       if event.type == QUIT:
          ...
          if esc1 > 0 and z != 132 and z != 33 and z != 43 and z != 53 and z != 141 and z != 143 and z != 154 and z != 85 and z != 95 and kz != K_ESCAPE and esc2 != 1:
             esc1 = 0
             keys(0,"Esc",fs,5,b3x,bw,2,b3y, bh, 2, 2, 0)
          ...
          if z == 115 or kz == 304 or kz == 303:
            ...
            change = 1
             ...
             if esc1 == 0:
                ...
                if auto_rotate == 0 and use_Pi_Cam == 1 and camera_connected == 1:
             ...
             while offtry < 10 and (offset6a == offset6):
                ...
                if (offset6a > 0 and offset6a >= h/2 - Disp_height/2) or (offset6a < 0 and offset6a <= Disp_height/2 - h/2):
                   offset6a -= offset4a
                offtry += 1
             if offtry < 10:
                offset6 = offset6a
             ...
             while offtry < 10 and (offset5a == offset5):
                ...
                if (offset5a > 0 and offset5a >= w/2 - Disp_Width/2) or (offset5a < 0 and offset5a <= Disp_Width/2 - w/2):
                   offset5a -= offset3a
                offtry += 1
             if offtry < 10:
                offset5 = offset5a
