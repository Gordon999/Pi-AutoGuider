...
#=============================================================================================================
use_config  =         0 # set pre-stored config to load at startup, 1, 2, 3 or 4. 4 will load last used config.
                        # !!! to use a pre-stored config (1,2 or 3) ensure you saved it when use_config was set = 0
#=============================================================================================================
...
if use_config > 0 and use_config < 5:
